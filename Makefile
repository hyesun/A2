...
client: client.o rpc.o 
	g++ -g -o0 -Wall -Wl,--no-as-needed -lpthread client.o librpc.a -o client
	
server: server.o rpc.o 
	g++ -g -o0 -Wall -Wl,--no-as-needed -lpthread server.o server_functions.o server_function_skels.o librpc.a -o server

binder: binder.o rpc.o
	g++ -g -o0 -Wall -Wl,--no-as-needed -lpthread binder.o librpc.a -o binder
